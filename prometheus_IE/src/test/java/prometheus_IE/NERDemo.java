...
//      classifier.printProbs(args[1], readerAndWriter);
      ...
      */
      ...
      //String[] example = {"Im Mai/Juni 1974 erfuhr der Wandbehang eine sorgfältige Restaurierung durch Ulrike Bauer, Regensburg. Dabei wurden die oxydierten Silberteile - mit Ausnahme der Pailletten - gereinigt und kleinere Löcher und Fehlstellen ausgebessert.Stifter des Thronbaldachins war der Fürstprimas Carl Theodor von Dalberg(1803-1817). Er hatte die Anlage für den Regensburger Dom beschafft, sie aber nach seinem teilweisen Auszug im Jahre 1810 nach" };
    String[] example ={"In Bonn, Köln, Düsseldorf, Münster, München, Hamburg und Berlin wird Aschermittwoch gefeitert."};	
